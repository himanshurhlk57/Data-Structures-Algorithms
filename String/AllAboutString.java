...
// Any character takes 1 byte of memory whereas 1 byte equals to 8 bits(1 byte = 8 bits)
// ch = 'a'; for its value to be stored in capacitor of ram we have to convert it into 0's and 1's because capacitor           only store 0's and 1's so for this every character has it ASCII value assigned to it for 'a' its 97.
// 	'a' -> 97(ASCII), 97 in Binary -> 0 1 1 0 0 0 0 1
		
		 
// Lets say we want to add to string nums1 = "123" and nums2 = "78" Both nums1 and nums2 are string and each of these digits are character.
// ASCII values of numbers range from 48-57
// 48 - '0', 49 - '1', 50 - '2', 51, '3', 52 - '4', 53 - '5', 54 - '6', 55 - '7', 56 - '8', 57 - '9';
// Lets convert '3' into number for that we know '3' ASCII is 51 to obtain 3 from 51 we have to subtract 48 from it i.e '0'
// 51 - 48 = 3, i.e '3' - '0';
